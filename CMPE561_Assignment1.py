...
print(correctly_tagged_word / (correctly_tagged_word + incorrectly_tagged_word))
print(correctly_tagged_sentence / (correctly_tagged_sentence + incorrectly_tagged_sentence))
