...
accuracy_of_tagging_words, accuracy_of_tagging_sentences, final_confusion_matrix, list_tag_accuracy = evaluation(sentences, original_or_stem, morph_inf)
print(accuracy_of_tagging_words)
print(accuracy_of_tagging_sentences)
print(final_confusion_matrix)
print(list_tag_accuracy)
